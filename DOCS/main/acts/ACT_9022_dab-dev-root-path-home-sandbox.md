...
**ADR collegate**: — (ADR dev/stage/prod in definizione dal team)   **OP collegati**: —
...
Il modello **dev=home / stage=condiviso-CI / prod** sarà formalizzato in un **ADR dedicato** dal team.
